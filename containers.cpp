...
const std::string LOGGING_TAG_YUCHEN = "YUCHEN";
...
BatchSizeInfo ModelContainer::get_batch_size(Deadline deadline) {
  ...
  log_info_formatted(LOGGING_TAG_YUCHEN, "Budget: {}, Method: {}, Max Batch Size: {}", std::to_string(budget), method_string, std::to_string(max_batch_size_));
